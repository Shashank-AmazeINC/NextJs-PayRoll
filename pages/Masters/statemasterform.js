          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="row">
              <div className="col-lg-3">
                <p>Country<i className="text-danger">*</i>
                </p>
                {/* <select>
              ...
              <div className="col-lg-3">
                ...
                <input name="Short" className="form-control" type="text" {...register("Short", { required: true })} placeholder="Province"/>
                  <div>{errors.Short && <span style={customStyles.errorMsg}>Please enter province name</span>}</div>
              </div>
